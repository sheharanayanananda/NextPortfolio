...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-warm)] text-[var(--text-charcoal)] font-sans transition-colors duration-300 selection:bg-[var(--highlight-selection)] selection:text-[var(--text-charcoal)]">
      {/* Navigation Header */}
        ...
        <section id="hero" className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start pt-6">
          <div className="md:col-span-8 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a href="#slate" className="bg-[var(--accent-rust)] hover:bg-[var(--accent-rust-hover)] text-[#FAF8F5] px-6 py-3 rounded-md text-sm font-semibold tracking-tight transition-all shadow-sm">
                Explore Solo Work
              </a>
              <a href="#projects" className="border border-[var(--border-light)] hover:bg-[var(--card-bg)] px-6 py-3 rounded-md text-sm font-semibold tracking-tight transition-all">
      ...
      <footer id="footer" className="border-t border-[var(--border-light)] bg-[var(--card-bg)] transition-colors duration-300 mt-24">
        <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-[var(--text-secondary)]">
