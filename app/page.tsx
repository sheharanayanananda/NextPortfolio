        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-8 md:items-center">
          <div className="md:col-span-7 space-y-6">
            <div className="flex flex-wrap gap-2 items-center">
              <div className="inline-flex items-center space-x-2 border border-[var(--border-light)] px-3 py-1 rounded-full text-xs font-mono-anthropic uppercase text-[var(--accent-rust)] bg-[var(--card-bg)]">
                <span>●</span>
                <span>Software Engineer & Builder</span>
              </div>
              <div className="inline-flex items-center space-x-1.5 border border-green-500/20 bg-green-500/5 px-3 py-1 rounded-full text-xs font-mono-anthropic uppercase text-green-600 dark:text-green-400">
            ...
            <div className="flex items-center space-x-4 pt-6">
              <a
                ...
                className="p-3 rounded-full border border-[var(--border-light)] hover:border-[var(--accent-rust)] text-[var(--text-secondary)] hover:text-[var(--accent-rust)] bg-[var(--card-bg)] hover:bg-[var(--card-hover-bg)] transition-all duration-300 shadow-sm hover:shadow-md"
          ...
          <div className="md:col-span-5 flex justify-center md:justify-end">
            <div className="relative w-full max-w-[320px] md:max-w-[380px] aspect-[2/3]">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-[var(--accent-rust)] to-[var(--border-light)] rounded-lg blur opacity-25"></div>
              <div className="relative border border-[var(--border-light)] p-2 rounded-lg bg-[var(--bg-warm)] overflow-hidden w-full h-full">
                <Image
                  src="/arc_card.svg"
                  alt="Arc Card"
                  fill
